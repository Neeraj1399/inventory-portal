...
//       onRefresh();
//       onClose();
//       // Optional: Trigger a "Success" toast here that asks if they want to assign gear
//     } catch (err) {
...
//                 className="w-full pl-4 pr-4 py-2.5 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all"
//                 value={formData.name}
//                 onChange={(e) =>
...
//                 />
//               </div>
//               {/* 🟢 Add this hint so users know the requirements */}
//               <p className="text-[10px] text-slate-400 mt-1 ml-1 leading-tight">
//                 7-12 chars: 1 Upper, 1 Lower, 1 Number, 1 Special (!@#$%^&*)
//               </p>
//             </div>
//           </div>
...
//               <strong>Note:</strong> You can assign hardware (Laptops, Mouse,
//               etc.) from the Asset Management tab after the employee profile is
//               created.
//             </p>
//           </div>
