            ...
            <div>
              ...
              <div className="relative flex items-center">
                ...
                <input
                  ...
                  required
                  className="w-full pl-10 pr-10 py-2.5 border border-slate-200 rounded-xl bg-slate-50 font-mono text-sm outline-none"
                  value={formData.password}
                  readOnly
                />
                <button
                  ...
                  className="absolute right-3 text-blue-600 hover:rotate-180 transition-transform duration-300"
