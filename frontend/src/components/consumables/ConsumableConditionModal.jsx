...
const ConsumableConditionModal = ({ isOpen, item, onClose, onRefresh }) => {
 ...
 {/* Backdrop */}
 <div
 className="absolute inset-0 bg-zinc-900 animate-in fade-in duration-300"
 onClick={onClose}
 />
 ...
 className="w-full px-5 py-4 bg-zinc-900 border border-zinc-800 rounded-2xl focus:ring-4 focus:ring-indigo-500/30/10 focus:border-indigo-500 outline-none transition-all font-medium text-sm"
 ...
 {/* Warning Note */}
 {formData.actionType === "SCRAP" && (
 <div className="flex gap-3 p-4 bg-rose-500/10 rounded-2xl border border-rose-100">
