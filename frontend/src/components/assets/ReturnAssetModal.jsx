...
const ReturnAssetModal = ({ isOpen, asset, onClose, onRefresh }) => {
  ...
  useEffect(() => {
    if (isOpen) setReturnStatus("AVAILABLE");
  }, [isOpen]);
  ...
  const getThemeColor = () => {
    if (returnStatus === "SCRAPPED")
      return "bg-red-50 border-red-100 text-red-600";
    if (returnStatus === "REPAIR")
              ...
              {[
                {
                  ...
                  icon: ShieldCheck,
                  activeClass:
                    "peer-checked:border-emerald-500 peer-checked:bg-emerald-50 text-emerald-600",
                },
                {
                  id: "REPAIR",
                  ...
                  icon: Wrench,
                  activeClass:
                    "peer-checked:border-amber-500 peer-checked:bg-amber-50 text-amber-600",
                },
                {
                  id: "SCRAPPED",
                  label: "Scrap / Broken",
                ...
                >
                  ...
                  />
                  <div
                    className={`flex items-center gap-4 p-4 border-2 border-slate-100 rounded-2xl transition-all hover:border-slate-200 ${stat.activeClass}`}
                  >
