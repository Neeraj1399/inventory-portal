...
//       `Are you sure you want to delete ${item.itemName}? This action cannot be undone and will remove all stock records.`,
//     );
...
//       await fetchConsumables(true);
//       alert("Product successfully scrapped/removed.");
//     } catch (err) {
//       console.error(err);
...
//               <div
//                 key={item._id}
//                 className="bg-white rounded-3xl border border-slate-200 shadow-sm hover:shadow-lg transition-all p-6 flex flex-col"
//               >
//                 <div className="flex justify-between items-start mb-4">
//                   <div
//                     className={`p-4 rounded-2xl ${isLowStock ? "bg-amber-100 text-amber-600" : "bg-blue-50 text-blue-600"}`}
//                   >
//                     <Package size={24} />
//                   </div>
...
//                       disabled={available === 0}
//                       onClick={() => openModal("ISSUE", item)}
//                       className="bg-slate-900 text-white p-3 rounded-xl hover:bg-blue-600 disabled:opacity-30 transition-colors"
//                     >
//                       <UserPlus size={18} />
//                     </button>
//                     <button
