...
//   // Safety Check 2: Request failed or data is empty
//   if (!data)
//     return (
...
//               {data.serializedAssets?.length || 0} Items
//             </p>
//           </div>
//         </div>
...
//             </p>
//             <p className="text-2xl font-bold text-slate-900">
//               {data.consumables?.length || 0} Types
//             </p>
//           </div>
//         </div>
...
//                       {/* FIX: Changed from asset.assetName to category/model */}
