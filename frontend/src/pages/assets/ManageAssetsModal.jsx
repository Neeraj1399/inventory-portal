...
// import { X, Laptop, RefreshCcw, PlusCircle, Loader2 } from "lucide-react";
...
//         api.get(`/assets?assignedTo=${employee._id}&t=${timestamp}`),
//         api.get(`/assets?status=AVAILABLE&t=${timestamp}`),
//       ]);
...
//     }
//   }, [employee._id]); // Removed assignedAssets.length to ensure fresh data on every manual trigger
...
//         <div
//           className={`bg-white rounded-3xl w-full max-w-2xl shadow-2xl flex flex-col max-h-[90vh] animate-in fade-in zoom-in-95 duration-200 transition-opacity ${isRefreshing ? "opacity-75" : "opacity-100"}`}
//         >
//           {/* Header */}
...
//                         <div
//                           key={asset._id}
//                           className="flex items-center justify-between p-3 bg-blue-50/50 rounded-2xl border border-blue-100"
//                         >
...
//                             disabled={actionLoading || isRefreshing}
//                             className="text-xs font-bold text-red-600 hover:bg-red-50 px-3 py-2 rounded-xl transition-all flex items-center gap-2 disabled:opacity-50"
//                           >
...
//                           <div
//                             key={asset._id}
//                             className="flex items-center justify-between p-3 bg-white border border-slate-200 rounded-2xl hover:border-blue-400 transition-all"
//                           >
//                             <div className="flex flex-col">
...
//                               disabled={actionLoading || isRefreshing}
//                               className="text-blue-600 hover:bg-blue-50 p-2 rounded-xl transition-all disabled:opacity-50"
//                             >
//                               {actionLoading ? (
                    ...
                    {availableAssets.length > 0 ? (
                      availableAssets
                        ...
                        .map((asset) => (
                          <div
                            key={asset._id}
                            className="flex items-center justify-between p-3 bg-white border border-slate-200 rounded-2xl hover:border-blue-400 transition-all group"
                          >
                            <div className="flex flex-col">
                              <span className="text-[10px] font-black text-blue-500 uppercase tracking-wider">
                                {asset.category || "LAPTOP"}
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <button
                                ...
                                className="text-slate-400 hover:text-amber-600 hover:bg-amber-50 p-2 rounded-xl transition-all disabled:opacity-50"
                              >
                                <Wrench size={20} />
                              </button>
